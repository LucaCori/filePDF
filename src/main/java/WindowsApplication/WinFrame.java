...
public class WinFrame extends JFrame {
	...
	public WinFrame() {
		...
		lblNewLabel_6.setBounds(156, 8, 131, 14);
		contentPane.add(lblNewLabel_6);
		
		final JLabel lblNewLabel_5 = new JLabel();
		lblNewLabel_5.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_5.setBounds(313, 95, 100, 15);
		...
		final String[] types = {"NONE", ".pdf", ".txt", ".docx", ".rtf", ".odt", ".xml"};
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if((textField.getText()).equals("") || (textField_1.getText()).equals("") || (textField_3.getText()).equals("")) {
					lblNewLabel_6.setText("Something is missing!");
				}
				else {
							...
							if(existing) {
								...
								if(type.equals(".pdf")){
									try {
										...
										pdf.create(name, message, path);
									} catch (IOException e1) {}
									lblNewLabel_6.setText("File created!");
								}
								else {
									try {
										FileWriter fileout = new FileWriter(textField_3.getText() + "/" + name);
		...
		btnNewButton_2.setBounds(310, 28, 100, 23);
		...
		JLabel lblNewLabel_7 = new JLabel("Directory");
		lblNewLabel_7.setBounds(118, 33, 60, 14);
		contentPane.add(lblNewLabel_7);
		
		textField_3 = new JTextField();
		textField_3.setEditable(false);
		textField_3.setBounds(188, 30, 100, 20);
